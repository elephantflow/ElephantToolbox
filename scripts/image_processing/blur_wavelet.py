...
def blur_detect(img, threshold):
    ...
    print(f"EdgePoint1: {EdgePoint1}")
    print(f"EdgePoint2: {EdgePoint2}")
    print(f"EdgePoint3: {EdgePoint3}")
    ...
    print(f"Emax1[EdgePoint]: {Emax1[EdgePoint]}")
    print(f"Emax2[EdgePoint]: {Emax2[EdgePoint]}")
    print(f"Emax3[EdgePoint]: {Emax3[EdgePoint]}")
    
    # Rule 2 Dirak-Structure or Astep-Structure
    DAstructure = (Emax1[EdgePoint] > Emax2[EdgePoint]) * (Emax2[EdgePoint] > Emax3[EdgePoint]);

    print(f"DAstructure: {DAstructure}")
...
if __name__ == '__main__':                
    ...
    parser.add_argument("-t", "--threshold", dest='threshold', type=float, default=1, help="blurry threshold")
    ...
    files.sort()
    input_paths = [os.path.join(args.input_dir, file) for file in files]
